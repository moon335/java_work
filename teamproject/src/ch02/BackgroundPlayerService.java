...
public class BackgroundPlayerService implements Runnable{
	...
	public void run() {
		while(true) {
			...
			Color leftColorX = new Color(image.getRGB(player.getX(), player.getY() + 40));
			Color rightColor = new Color(image.getRGB(player.getX() + 40, player.getY() + 45));
			Color rightColorX = new Color(image.getRGB(player.getX() + 40, player.getY() + 10));
			Color topColor = new Color(image.getRGB(player.getX(), player.getY() - 3));
			Color topColorX = new Color(image.getRGB(player.getX() + 30, player.getY()));
			Color bottomColor = new Color(image.getRGB(player.getX() - 3, player.getY() + 50));
			Color bottomColorX = new Color(image.getRGB(player.getX() + 15, player.getY() + 5));
...
//			System.out.println("왼쪽 " + leftColor);
			...
			System.out.println((player.getX() + 15) + " z" + "z " + (player.getY() + 5));
