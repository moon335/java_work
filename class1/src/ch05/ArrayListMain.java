...
public class ArrayListMain {
	...
	public static void main(String[] args) {
		...
		list.add(1, 20); // index 번호, 값 할당: 인덱스 1번 - 20
		// 3 20 null 100
...
//		System.out.println(list.size());
		...
		// 값을 화면에 출력하는 방법
		System.out.println("-------------------------------------");
		System.out.println(list.get(2)); // 배열은 인덱스 연산 처리, ArrayList .get() 연산자를 호출
		...
		// hasNext() -> 다음에 값이 있는지 없는지 true false
		while(iter.hasNext()) {
