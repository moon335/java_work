...
public class MapMainTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(map1.get("b01")); // B01 != b01 없는 키 값을 요청하면 null 반환
		...
		// map은 원래 순서가 없지만 잠깐 응용을 하면 key 값으로 for문 정도는 활용할 수 있다.
